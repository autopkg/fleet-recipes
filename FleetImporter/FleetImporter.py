...
class FleetImporter(Processor):
    ...
    def _run_direct_upload_workflow(self):
        ...
        if icon_path_str and title_id:
            icon_path = Path(icon_path_str).expanduser().resolve()
            if icon_path.exists():
    ...
    def _upload_to_s3(
        ...
        try:
            ...
            try:
                with urllib.request.urlopen(put_request, timeout=900) as put_response:
    ...
    def _cleanup_old_s3_versions(
        ...
        try:
            ...
            try:
                with urllib.request.urlopen(list_request, timeout=30) as list_response:
